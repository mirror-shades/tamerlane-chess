...
{
public:
    Types::Turn minMax(GameLogic gameLogic, char player, int turn, bool alt, int depth, float alpha, float beta);
    ...
    float quiescenceSearch(char player, float alpha, float beta, int maxDepth = 4);
